...
opts = {
    ...
    repaintColor: '#F2F2F2',
    connectionColor: '#020F59',
    rootColor: '#0339A6',
    endColor: '#5679A6',
    dataColor: '#020F59',

    wireframeWidth: .1,
    wireframeColor: '#F3F7DD',
...
ctx.fillText('Dowen Robinson', w / 2 - ctx.measureText('Dowen Robinson').width / 2, h / 2 - 15);
...
Connection.prototype.step = function(){
    ...
    this.setScreen();
    this.screen.color = (this.isEnd ? opts.endColor : opts.connectionColor).replace('light', 30 + tick * this.glowSpeed % 30).replace('alp',
    .2 + (1 - this.screen.z / mostDistant) * .8);
